...
Version: 1.1 (read by Compare-GPOXml.ps1 4.x, Compare-GPOHtml.ps1 2.x and New-GpoConsolidationPlan.ps1 1.x)
...
| Microsoft Defender Application Guard | Category | Application Guard | Deprecated; removed from Windows 11 version 24H2 | Microsoft Defender SmartScreen / Attack Surface Reduction / Windows Sandbox | |
...
- **Application Guard:** the `Category` row matches both the "Microsoft Defender Application Guard" and the older "Windows Defender Application Guard" category names.
